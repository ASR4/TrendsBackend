package com.asr.trends.model.walmart;
...
public class Items
{
    ...
    private String freeShippingOver35Dollars;
    ...
    public String getFreeShippingOver35Dollars ()
    {
        return freeShippingOver35Dollars;
    }

    public void setFreeShippingOver35Dollars (String freeShippingOver35Dollars)
    {
    ...
    {
        return "ClassPojo [ninetySevenCentShipping = "+ninetySevenCentShipping+", freeShippingOver35Dollars = "+freeShippingOver35Dollars+", affiliateAddToCartUrl = "+affiliateAddToCartUrl+", customerRatingImage = "+customerRatingImage+", standardShipRate = "+standardShipRate+", thumbnailImage = "+thumbnailImage+", brandName = "+brandName+", giftOptions = "+giftOptions+", productTrackingUrl = "+productTrackingUrl+", stock = "+stock+", categoryNode = "+categoryNode+", msrp = "+msrp+", numReviews = "+numReviews+", mediumImage = "+mediumImage+", name = "+name+", shipToStore = "+shipToStore+", longDescription = "+longDescription+", addToCartUrl = "+addToCartUrl+", gender = "+gender+", bundle = "+bundle+", imageEntities = "+imageEntities+", customerRating = "+customerRating+", rhid = "+rhid+", largeImage = "+largeImage+", parentItemId = "+parentItemId+", clearance = "+clearance+", itemId = "+itemId+", upc = "+upc+", size = "+size+", categoryPath = "+categoryPath+", offerType = "+offerType+", availableOnline = "+availableOnline+", shortDescription = "+shortDescription+", color = "+color+", productUrl = "+productUrl+", salePrice = "+salePrice+", attributes = "+attributes+", freeShipToStore = "+freeShipToStore+", isTwoDayShippingEligible = "+isTwoDayShippingEligible+", preOrder = "+preOrder+", modelNumber = "+modelNumber+", bestMarketplacePrice = "+bestMarketplacePrice+"]";
    }
}